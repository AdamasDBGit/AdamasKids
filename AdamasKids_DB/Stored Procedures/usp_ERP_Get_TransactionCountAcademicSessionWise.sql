...
--- Success Transaction
 ...
 and 
  ...
  select DISTINCT SI.*,PST.StatusDescription as PaymentStatus from #UnSuccessFulExternalTransaction as SI
  left join @PaymentStatusTable as PST on SI.PaymentStatusID=PST.PaymentStatusID
