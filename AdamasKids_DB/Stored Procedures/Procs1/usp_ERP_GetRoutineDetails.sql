...
BEGIN TRY  
 ...
 select   
 I_Total_Periods AS TotalPeriods, T_Start_Slot AS StartTimeOfFirstPeriod, T_Duration AS DurationOfEachPeriod, T_Period_Gap AS IntervalTimeBetweenTwoPeriods, I_Break_Period_No AS PeriodNumberBeforeLunchBreak, T_Break_Period_Duration AS LunchBreakDuration, 
I_No_Of_WeekDays AS NumberOfWeekDays, I_Routine_Structure_Header_ID AS HeaderID  
