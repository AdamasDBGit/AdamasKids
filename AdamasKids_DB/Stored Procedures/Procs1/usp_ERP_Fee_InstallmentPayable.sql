--exec [usp_ERP_Fee_InstallmentPayable] 28,1,0  
...
-----------     -----------------------------------------------------------      
  ...
  t2.CGST_Amt,      
     t2.SGST_Amt,      
     t2.CGST_Amt+t2.SGST_Amt as IGST_Amt,      
  t2.CGST_Per,      
  t2.SGST_Per,      
  t2.IGST_Per      
  ...
  -- @sessionstDt as Dt_Payment_Installment_Dt,        
   ...
   CEILING(CGST_Amt)+CEILING(SGST_Amt) as IGST_Amt ,      
   CGST_Per,      
   SGST_Per,      
   IGST_Per      
 ...
 IGST_Per      
	...
	(CEILING(fi.SGST_Amt / fi.I_Pay_InstallmentNo)+CEILING(fi.CGST_Amt / fi.I_Pay_InstallmentNo)) as IGSTAmount
