...
--exec [dbo].[ERP_uspGetPreEnquiryDetails_POC] null,null, null,null, null,null, null, 100, 0, 0, 'asc', null           
...
End
 ...
 LEFT JOIN (SELECT     
             I_Followup_ID, I_Enquiry_Regn_ID, Dt_Next_Followup_Date, ERP_R_I_FollowupType_ID,   
